...
Admissions By Health Board, Age and Sex: We used this dataset to answer questions on the impact of Covid on provision of acute care as it had demographic and geographic information relating to the number of hospital admissions compared to the pre-Covid average. It also helped to answer the winter crisis question as changes across seasons could be identified.

Activity by Board of Treatment, Age and Sex: We used this data to answer the impact of Covid on different demographics as it contained information on the length of stay on different ages and sexes.
